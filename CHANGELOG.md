...
- **`--trim` single-pixel islands**: One-pixel color regions are now removed even when pixels of another color touch their edges, preventing unprintable singleton mesh objects from reaching the 3MF output.
